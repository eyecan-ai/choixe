...
class CustomUserObject__(Spook):
    def __init__(self, a: int = None, b: str = None, c: bool = None) -> None:
        super().__init__()
        self._misc = (a, b, c)
    ...
    def __eq__(self, o: object) -> bool:
        return (
            self._misc[0] == o._misc[0]
            and self._misc[1] == o._misc[1]
            and self._misc[2] == o._misc[2]
        )
...
class NestedUserObject_(Spook):
    ...
    @classmethod
    def spook_schema(cls) -> dict:
        return {"name": str, "o0": dict, "o1": dict}
    ...
    def __eq__(self, o: object) -> bool:
        return self._name == o._name and self._o0 == o._o0 and self._o1 == o._o1
